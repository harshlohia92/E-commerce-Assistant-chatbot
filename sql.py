...
def sql_chain(question):
    ...
    safe_context = " ".join(words[:800])
    answer = data_comprehension(question,safe_context)
    return answer

if __name__ == '__main__':
    question = 'Give me ADIDAS shoes with rating higher than 4 and more than 30% discount'
